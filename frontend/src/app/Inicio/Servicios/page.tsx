        ...
        <div className="flex-grow flex flex-col">
          ...
          <main className="flex-grow p-6 bg-white">
            ...
            <div className="max-w-4xl mx-auto p-4">
              <h2 className="text-center text-2xl font-semibold mb-6">Contratacion de servicio</h2>
              <form className="space-y-6">
                <div>
                  <label className="black text-lg font-medium mb-2 text-black">Nombre del cliente</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-lg font-medium mb-2 text-black">Fecha de cotratacion</label>
                  <input
                    type="text"
                    className="w-full p-3 border  text-black -300 rounded-md"
                    placeholder="Ingrese información"
